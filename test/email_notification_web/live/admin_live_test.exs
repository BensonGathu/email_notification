defmodule EmailNotificationWeb.AdminLiveTest do
  use EmailNotificationWeb.ConnCase

  import Phoenix.LiveViewTest
  import EmailNotification.AdminsFixtures

  @create_attrs %{admin_role: "some admin_role"}
  ...
  describe "Index" do
    ...
    test "updates admin in listing", %{conn: conn, admin: admin} do
      ...
      assert html =~ "some updated admin_role"
    end
