defmodule EmailNotificationWeb.GroupLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :groups, Groups.get_groups_by_userID!(socket.assigns.current_user.id))}
  end
  ...
  @impl true
  def handle_info({EmailNotificationWeb.GroupLive.FormComponent, {:saved, group}}, socket) do
